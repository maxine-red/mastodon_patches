...
sanitized_sed 'request_locale || I18n.default_locale' 'case request_locale\n      when \/en\\b\/, nil\n        I18n.default_locale\n      else\n        request_locale\n      end' ../app/controllers/concerns/localized.rb
add_locale () {
  if ! grep -q "$2" $3; then
    sanitized_sed "$1" "\0\n$2" $3
  fi
